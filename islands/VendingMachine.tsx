...
const menuItem = apply`fill-current text-gray-200`;
const activeMenuItem = apply`fill-current text-yellow-200`;
const activeMenuSecondItem = apply`text-gray-500`;
let count = 0;
...
export default function VendingMachine() {
  ...
  const activeAnimate = async () => {
    if (count < 60) {
      ...
      setActiveItem(random(15));
      globalThis.requestAnimationFrame(activeAnimate);
    } else {
      // 如果动画执行已经到了5s，停止动画，更新状态
      // 假装再更新一次
      setTimeout(() => {
        count = 0;
        setActive("END");
  ...
  useEffect(() => {
    if (active === "SHIPPING") startShipping();
  }, [active]);
  ...
  return (
    <div class={tw`w-[900px] mx-auto px-4 mt-4`}>
      <svg
        version="1.0"
        xmlns="http://www.w3.org/2000/svg"
        height="740px"
        viewBox="0 0 1805.000000 2757.000000"
        preserveAspectRatio="xMidYMid meet"
        class={tw`mx-auto`}
        fill={active === "INIT" ? "#F3F4F6" : "#6B7280"}
      >
        <g
          transform="translate(0.000000,2757.000000) scale(0.100000,-0.100000)"
          // class={tw`fill-current text-green-600`}
          stroke="none"
        >
          <path
            d="M1605 27560 c-431 -28 -822 -211 -1121 -522 -241 -252 -392 -550
...
4 3398 7 7446 6 l7360 -1 90 -24z"
          />
          <path
            d="M2815 24923 c-156 -12 -278 -44 -398 -104 -336 -167 -550 -476 -587
...
36 4 1993 7 4350 6 4113 -1 4287 -2 4345 -20z"
          ...
          <path
            class={tw`${menuItem}  ${
              activeItem === 0
                ? activeMenuItem
                : active !== "INIT" && activeMenuSecondItem
            }`}
            d="M3007 23296 c-90 -33 -153 -95 -188 -186 -18 -48 -19 -86 -19 -973 0
...
674 64 l586 0 34 -23z"
          ...
          <path
            ...
            d="M5317 23295 c-77 -29 -146 -94 -185 -175 -16 -32 -17 -115 -17 -980
...
2 912 23 940 11 15 36 38 54 51 l33 22 587 0 587 0 34 -23z"
          ...
          <path
            ...
            d="M7605 23282 c-60 -29 -121 -86 -149 -140 -34 -67 -37 -143 -34 -1047
...
23 44 c12 25 37 55 56 67 l34 23 584 0 c522 0 589 -2 620 -16z"
          ...
          <path
            ...
            d="M9934 23290 c-67 -27 -123 -76 -159 -141 l-30 -54 -3 -939 c-2 -840
...
11 28 59 77 86 89 11 4 282 8 603 8 499 1 587 -1 612 -14z"
          />
          <path
            d="M2580 20755 l0 -145 4535 0 4535 0 0 145 0 145 -4535 0 -4535 0 0
-145z"
          />
          <path
            class={tw`${menuItem}  ${
            ...
            d="M3019 19667 c-58 -16 -131 -69 -164 -119 -57 -86 -55 -44 -55 -1044
...
c0 979 -2 935 52 985 12 12 34 26 48 32 16 6 242 10 600 10 l575 1 40 -23z"
          ...
          <path
            ...
            d="M5345 19671 c-89 -23 -178 -101 -211 -187 -18 -47 -19 -88 -19 -979
...
68 680 65 578 -2 587 -2 615 -23z"
          ...
          <path
            ...
            d="M7650 19667 c-93 -26 -153 -78 -197 -172 l-28 -60 0 -930 0 -930 29
...
45 60 58 l40 24 581 0 581 0 34 -23z"
          ...
          <path
            ...
            d="M9948 19664 c-56 -17 -149 -99 -181 -158 l-22 -41 -3 -942 c-2 -932
...
12 12 34 26 48 32 16 6 242 10 600 10 l575 1 40 -23z"
          />
          <path
            d="M2580 17140 l0 -140 4535 0 4535 0 0 140 0 140 -4535 0 -4535 0 0
-140z"
          />
          <path
            class={tw`${menuItem}  ${
            ...
            d="M2993 16064 c-57 -21 -128 -86 -161 -148 l-27 -51 0 -955 0 -955 27
...
34 c13 18 42 42 65 52 38 17 76 19 597 19 389 0 566 -3 590 -11z"
          ...
          <path
            ...
            d="M5293 16056 c-64 -30 -122 -87 -154 -152 l-24 -49 0 -940 c0 -757 3
...
903 c0 897 0 904 21 938 26 43 56 68 94 80 18 6 268 9 601 8 l570 -2 41 -27z"
          ...
          <path
            ...
            d="M7640 16071 c-79 -24 -165 -106 -196 -186 -18 -48 -19 -87 -19 -980
...
72 90 94 37 17 78 19 600 19 l561 0 44 -22z"
          ...
          <path
            ...
            d="M9933 16064 c-57 -21 -128 -86 -161 -148 l-27 -51 0 -955 0 -955 27
...
58 63 99 75 14 5 276 9 581 9 519 1 558 -1 595 -18z"
          />
          <path
            d="M2587 13663 c-4 -3 -7 -69 -7 -145 l0 -138 4535 0 4535 0 0 145 0
145 -4528 0 c-2491 0 -4532 -3 -4535 -7z"
          ...
          <path
            ...
            d="M2972 12419 c-73 -36 -124 -92 -152 -167 -20 -53 -20 -71 -18 -990
...
65 27 64 674 64 l586 0 34 -23z"
          ...
          <path
            ...
            d="M5327 12440 c-50 -15 -123 -69 -153 -112 -62 -88 -59 -27 -59 -1053
...
l33 22 585 0 c577 0 585 0 622 -21z"
          ...
          <path
            ...
            d="M7635 12437 c-86 -34 -150 -93 -188 -175 l-22 -47 0 -935 0 -935 26
...
876 24 910 11 19 35 45 54 57 l33 23 584 0 c522 0 589 -2 620 -16z"
          ...
          <path
            ...
            d="M9954 12439 c-85 -24 -180 -121 -204 -207 -6 -24 -10 -360 -10 -953
...
-59 10 -59 10 -1 -1 -22 -5 -48 -9z"
          ...
          <g class={tw`group`}>
            {/* 指示箭头 arrow */}
            <path
              class={tw`${active !== "SHIPPING" && "animate-mini-bounce"}`}
              d="M14689 18184 c218 -217 401 -395 406 -395 6 0 188 178 406 395 l395
396 -801 0 -802 0 396 -396z"
            />
            {/* 投币入口 coin */}
            <path
              onClick={(e) => {
                if (active === "INIT") setActive("SHIPPING");
                if (active === "END") {
                  setActive("INIT");
                  setActiveItem(undefined);
                }
              }}
              class={tw`fill-current text-gray-200 hover:text-green-400 hover:(cursor-pointer) ${
                active !== "INIT" && "text-gray-500 hover:(text-gray-500)"
              }`}
              d="M 13895 17266 c -70 -22 -122 -54 -174 -107 c -87 -89 -129 -213 -118 -352 c 11 -144 69 -251 176 -324 c 113 -78 28 -73 1316 -73 c 1284 0 1201 -4 1313 71 c 139 92 207 282 168 468 c -8 40 -25 92 -37 117 c -34 66 -114 143 -189 178 l -65 31 l -1175 2 c -930 1 -1183 -1 -1215 -11 z m 2351 -306 z"
            />
          </g>

          <path
            d="M14830 14280 l0 -850 265 0 265 0 0 850 0 850 -265 0 -265 0 0 -850z
m335 0 l0 -655 -70 -3 -70 -3 2 658 c2 362 3 659 3 661 0 2 30 2 68 0 l67 -3
0 -655z"
          />
          <path
            d="M14685 7240 c220 -220 402 -400 405 -400 3 0 187 180 410 400 l405
399 -810 0 -810 1 400 -400z"
          />
          <path
            d="M2420 7154 c-90 -24 -210 -89 -277 -149 -69 -62 -141 -163 -172 -242
...
2108 7 4627 6 l4580 -1 60 -24z"
          />
          <path
            d="M14065 6554 c-200 -49 -361 -197 -432 -399 l-28 -80 0 -540 0 -540
